#ifndef HRP_BFP_META_FOR_STANDARD_INCLUDED
#define HRP_BFP_META_FOR_STANDARD_INCLUDED
...
float4 frag_meta(Varyings input) : SV_Target
{
    ...
    float4 gloss = SAMPLE_TEXTURE2D(_SpecularTex, sampler_SpecularTex, input.uv);
