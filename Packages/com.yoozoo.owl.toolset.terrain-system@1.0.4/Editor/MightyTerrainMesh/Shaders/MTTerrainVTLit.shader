...
#pragma multi_compile __ _ALPHATEST_ON
	...
	SubShader
	{
		...
		Pass
		{
			...
			/*#include "Packages/hrp2/RenderPipeline/ShaderLibrary/SRP/Core.hlsl"
			#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/CommonMaterial.hlsl"
			#include "Packages/hrp2/RenderPipeline/ShaderLibrary/SRP/SurfaceInput.hlsl"
			#include "Packages/hrp2/RenderPipeline/ShaderLibrary/SRP/Lighting.hlsl"*/
