Shader "TerrainSystem/HRP/TerrainLitBasemap"
{
	Properties{
		_Diffuse("Diffuse", 2D) = "grey" {}
		_Normal("Normal", 2D) = "grey" {}
		[NoScaleOffset]_TerrainHolesTexture("Hole", 2D) = "red" {}
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag(Varyings IN) : SV_TARGET
			{
				...
				half3 normalTS = UnpackNormalAG(mixedNormal.ggrr);
		...
		Pass
		{
			...
			#include "Packages/com.yoozoo.owl.toolset.terrain-system@1.0.4/ShaderLibrary/AdapterHRP/RenderPipeline/Shaders/Pipeline/BFP/Core/BFP_StandardDepthOnly.hlsl"
			ENDHLSL
		}
	}
