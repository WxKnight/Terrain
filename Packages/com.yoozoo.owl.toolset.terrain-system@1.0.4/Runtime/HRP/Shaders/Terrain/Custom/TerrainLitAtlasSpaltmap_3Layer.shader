Shader "TerrainSystem/HRP/TerrainLitAtlasSplatmap_3Layer" 
{
	Properties{
...
#define _NORMALMAP
			...
			void SplatmapMix(in half4 uvSplat01, in half2 uvSplat23, inout half3 splatControl, out half4 mixedDiffuse, out half3 defaultSmoothness, inout half3 mixedNormal)
			{
				half4 diffAlbedo[3];
				...
				defaultSmoothness = half3(1.0h, 1.0h, 1.0h) - half3(diffAlbedo[0].a, diffAlbedo[1].a, diffAlbedo[2].a);
			...
			half4 SplatmapFragment(Varyings IN) : SV_TARGET
			{
				...
				half4 uvSplat01 = 0;
				half2 uvSplat23 = 0;
				uint2 offset2 = uint2(controlVec.z & 0x3, controlVec.z >> 2);
				...
				//*****************************************************************
				half3 splatControl = SAMPLE_TEXTURE2D(_Weight, sampler_Weight, splatUV).xyz;
