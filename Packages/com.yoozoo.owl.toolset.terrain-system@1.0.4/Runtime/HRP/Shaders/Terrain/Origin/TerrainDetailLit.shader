Shader "Hidden/TerrainSystem/HRP/TerrainEngine/Details/UniversalPipeline/Vertexlit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.yoozoo.owl.toolset.terrain-system/ShaderLibrary/AdapterURP/Shaders/UnlitInput.hlsl"
            #include "Packages/com.yoozoo.owl.toolset.terrain-system/ShaderLibrary/AdapterURP/Shaders/DepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Packages/com.yoozoo.owl.toolset.terrain-system/ShaderLibrary/AdapterURP/Shaders/SimpleLitInput.hlsl"
            #include "Packages/com.yoozoo.owl.toolset.terrain-system/ShaderLibrary/AdapterURP/Shaders/SimpleLitMetaPass.hlsl"
