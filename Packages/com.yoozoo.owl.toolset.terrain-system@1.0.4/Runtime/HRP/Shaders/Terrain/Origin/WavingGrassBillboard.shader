...
Shader "Hidden/TerrainEngine/Details/UniversalPipeline/BillboardWavingDoublePass"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.yoozoo.owl.toolset.terrain-system/ShaderLibrary/AdapterURP/Shaders/Terrain/WavingGrassInput.hlsl"
            #include "Packages/com.yoozoo.owl.toolset.terrain-system/ShaderLibrary/AdapterURP/Shaders/Terrain/WavingGrassPasses.hlsl"
            ENDHLSL
        }
